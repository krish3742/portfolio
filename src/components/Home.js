        ...
        <div className="relative isolate w-screen flex items-center justify-center">
          ...
          <div className={Style.container}>
            <div className="my-4 w-[2/4] h-min max-w-xl flex items-center justify-center">
              <div className="w-min lg:w-max">
                ...
                <div className="max-w-fit my-2 cursor-pointer">
                  <div
                    className="relative rounded-full px-3 py-1 text-sm leading-6 text-white/40 ring-1 ring-white/10 hover:ring-white/20 hover:text-white/80"
                    onClick={(evt) => handleDownloadResumeClick(evt)}
                  >
                    Download Resume
                  </div>
                </div>
            ...
            <div className={Style.imgDiv}>
              <img
                className="bg-contain h-min"
                src={require("../documents/MyImage.png")}
                alt="MyImage"
              />
            </div>
          </div>
