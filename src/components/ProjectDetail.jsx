...
const ProjectDetails = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-[#030014] relative overflow-hidden px-4 md:px-6 py-8 md:pt-16">
              ...
              <div className="space-y-6 md:space-y-10 animate-slideInRight">
                <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl group">
                  ...
                  <img
                    src={project.Img}
                    alt={project.Title}
                    className="w-full h-[20rem] object-cover object-center transform text-white transition-transform duration-700 will-change-transform group-hover:scale-105"
                  />
